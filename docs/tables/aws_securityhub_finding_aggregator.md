...
|------------|-------------|
| `securityhub:ListFindingAggregators` | Required to list finding aggregators |
| `securityhub:GetFindingAggregator` | Required to get finding aggregator details |

**Note:** The `securityhub:GetFindingAggregator` permission is required to retrieve the `finding_aggregation_region`, `region_linking_mode`, and `regions` columns.
