...
| `servicequotas:ListAWSDefaultServiceQuotas` | Required to list default service quotas |
| `servicequotas:GetAWSDefaultServiceQuota` | Required to get a specific default service quota |
