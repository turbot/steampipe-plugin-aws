...
### CacheHit sum below 10 of an elasticache cluster for for the last 7 days
Determine the areas in which an ElastiCache cluster has had a sum of cache hits below 10 in the last week. This can be used to identify potential performance issues or under-utilization of resources.
...
### Lambda function daily maximum duration over 100 milliseconds
Determine the instances where the daily maximum duration of a specific Lambda function exceeds 100 milliseconds within a given one-month period. This can be useful for identifying potential performance issues and ensuring optimal function performance.
...
### CPU average utilization of an RDS DB instance over 80% for the last 30 days
Determine the instances where the average CPU utilization of an RDS DB instance exceeded 80% in the past 30 days. This query is useful for identifying potential performance issues or capacity planning.
...
### Maximum Bucket size daily statistics of an S3 bucket
Explore the daily storage usage of a specific S3 bucket within a specified date range. This can help in monitoring storage trends and planning for future storage needs.
