...
|------------|-------------|
| `cloudformation:DescribeStacks` | Required to list and describe stacks |
| `cloudformation:GetTemplate` | Required to get stack template |
| `cloudformation:DescribeStackResources` | Required to get stack resources |
