...
|------------|-------------|
| `ssm:GetInventory` | Required to list inventory data for managed instances. |
| `ssm:GetInventorySchema` | Required to get the inventory schema definitions (for the `schema` column). |
