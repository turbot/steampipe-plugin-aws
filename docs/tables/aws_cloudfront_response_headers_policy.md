...
|------------|-------------|
| `cloudfront:ListResponseHeadersPolicies` | Required to list response headers policies |
| `cloudfront:GetResponseHeadersPolicy` | Required to get response headers policy details |

**Note:** The `cloudfront:GetResponseHeadersPolicy` permission is required for the following column: `etag`.
