...
run_test aws_account
run_test aws_acm_certificate
run_test aws_api_gateway_api_authorizer
...
run_test aws_auditmanager_evidence
run_test aws_auditmanager_evidence_folder
run_test aws_auditmanager_framework
run_test aws_availability_zone
run_test aws_backup_plan
run_test aws_backup_protected_resource
run_test aws_backup_recovery_point
run_test aws_backup_selection
run_test aws_backup_vault
run_test aws_cloudcontrol_resource
...
run_test aws_cloudtrail_trail_event
run_test aws_cloudwatch_alarm
run_test aws_cloudwatch_log_event
run_test aws_cloudwatch_log_group
run_test aws_cloudwatch_log_metric_filter
run_test aws_cloudwatch_log_resource_policy
run_test aws_cloudwatch_log_stream
run_test aws_cloudwatch_metric
...
run_test aws_cost_by_account_daily
run_test aws_cost_by_account_monthly
run_test aws_cost_by_service_daily
run_test aws_cost_by_service_monthly
run_test aws_cost_by_service_usage_type_daily
run_test aws_cost_by_service_usage_type_monthly
run_test aws_cost_forecast_daily
run_test aws_cost_forecast_monthly
run_test aws_cost_usage
run_test aws_dax_cluster
run_test aws_directory_service_directory
run_test aws_dms_replication_instance
run_test aws_dynamodb_backup
run_test aws_dynamodb_global_table
run_test aws_dynamodb_metric_account_provisioned_read_capacity_util
run_test aws_dynamodb_metric_account_provisioned_write_capacity_util
run_test aws_dynamodb_table
run_test aws_ebs_snapshot
run_test aws_ebs_volume
run_test aws_ebs_volume_metric_read_ops
run_test aws_ebs_volume_metric_read_ops_daily
run_test aws_ebs_volume_metric_read_ops_hourly
run_test aws_ebs_volume_metric_write_ops
run_test aws_ebs_volume_metric_write_ops_daily
run_test aws_ebs_volume_metric_write_ops_hourly
run_test aws_ec2_ami
run_test aws_ec2_ami_shared
run_test aws_ec2_application_load_balancer
run_test aws_ec2_application_load_balancer_metric_request_count
run_test aws_ec2_application_load_balancer_metric_request_count_daily
...
run_test aws_ec2_instance_availability
run_test aws_ec2_instance_metric_cpu_utilization
run_test aws_ec2_instance_metric_cpu_utilization_daily
run_test aws_ec2_instance_metric_cpu_utilization_hourly
run_test aws_ec2_instance_type
...
run_test aws_ec2_network_load_balancer_metric_net_flow_count
run_test aws_ec2_network_load_balancer_metric_net_flow_count_daily
...
run_test aws_ecs_cluster_metric_cpu_utilization
run_test aws_ecs_cluster_metric_cpu_utilization_daily
run_test aws_ecs_cluster_metric_cpu_utilization_hourly
run_test aws_ecs_container_instance
run_test aws_ecs_service
run_test aws_ecs_task
...
run_test aws_elasticache_redis_metric_cache_hits_hourly
run_test aws_elasticache_redis_metric_curr_connections_hourly
run_test aws_elasticache_redis_metric_engine_cpu_utilization_hourly
run_test aws_elasticache_redis_metric_get_type_cmds_hourly
run_test aws_elasticache_redis_metric_list_based_cmds_hourly
run_test aws_elasticache_redis_metric_new_connections_hourly
...
run_test aws_emr_cluster_metric_is_idle
...
run_test aws_lambda_function_metric_duration_daily
run_test aws_lambda_function_metric_errors_daily
run_test aws_lambda_function_metric_invocations_daily
run_test aws_lambda_layer
...
run_test aws_rds_db_instance_metric_connections
run_test aws_rds_db_instance_metric_connections_daily
run_test aws_rds_db_instance_metric_connections_hourly
run_test aws_rds_db_instance_metric_cpu_utilization
run_test aws_rds_db_instance_metric_cpu_utilization_daily
run_test aws_rds_db_instance_metric_cpu_utilization_hourly
run_test aws_rds_db_instance_metric_read_iops
run_test aws_rds_db_instance_metric_read_iops_daily
run_test aws_rds_db_instance_metric_read_iops_hourly
run_test aws_rds_db_instance_metric_write_iops
run_test aws_rds_db_instance_metric_write_iops_daily
run_test aws_rds_db_instance_metric_write_iops_hourly
...
run_test aws_redshift_cluster_metric_cpu_utilization_daily
...
run_test aws_s3_account_settings
...
run_test aws_sagemaker_training_job
...
run_test aws_vpc_flow_log_event
...
run_test aws_vpc_security_group_rule
...
run_test aws_workspaces_workspace
