...
output "resource_aka" {
  value = aws_inspector_assessment_template.named_test_resource.arn
}
...
output "assessment_target_aka" {
  value = aws_inspector_assessment_target.assessment_target.arn
}
