...
output "resource_aka" {
  value = "arn:${data.aws_partition.current.partition}:cloudfront::${data.aws_caller_identity.current.account_id}:origin-request-policy/${aws_cloudfront_origin_request_policy.named_test_resource.id}"
}
