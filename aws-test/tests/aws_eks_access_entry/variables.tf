...
output "access_entry_arn" {
  value = aws_eks_access_entry.named_test_resource.access_entry_arn
}

output "username" {
  value = aws_eks_access_entry.named_test_resource.username
}

output "type" {
  value = aws_eks_access_entry.named_test_resource.type
}

output "kubernetes_groups" {
  value = aws_eks_access_entry.named_test_resource.kubernetes_groups
}
