...
resource "aws_emr_security_configuration" "named_test_resource" {
  ...
  "EncryptionConfiguration": {
    "AtRestEncryptionConfiguration": {
      ...
      "LocalDiskEncryptionConfiguration": {
        ...
        "AwsKmsKey": "${aws_kms_key.named_test_resource.arn}"
      }
    },
...
output "creation_date" {
  value = aws_emr_security_configuration.named_test_resource.creation_date
}

output "cfg" {
  value = aws_emr_security_configuration.named_test_resource.configuration
}
