...
resource "aws_sagemaker_user_profile" "named_test_resource" {
  domain_id         = aws_sagemaker_domain.named_test_resource.id
  user_profile_name = var.resource_name
}

resource "aws_sagemaker_app" "named_test_resource" {
  domain_id         = aws_sagemaker_domain.named_test_resource.id
  user_profile_name = aws_sagemaker_user_profile.named_test_resource.user_profile_name
  app_name          = var.resource_name
...
output "user_profile_name" {
  value = aws_sagemaker_user_profile.named_test_resource.user_profile_name
}
...
output "resource_aka" {
  value = aws_sagemaker_app.named_test_resource.arn
}

output "resource_id" {
  value = aws_sagemaker_app.named_test_resource.id
}
