...
- Recompiled plugin with [steampipe-plugin-sdk v4.1.4](https://github.com/turbot/steampipe-plugin-sdk/blob/main/CHANGELOG.md#v414-2022-08-26) which fixes the stalling of dashboard queries and compliance checks. ([#1261](https://github.com/turbot/steampipe-plugin-aws/pull/1261))
