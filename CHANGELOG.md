...
- Recompiled plugin with [steampipe-plugin-sdk v4.1.10](https://github.com/turbot/steampipe-plugin-sdk/blob/main/CHANGELOG.md#v4110-2023-01-24) which fixes the issue of non-caching of all the columns of the queried table. ([#1554](https://github.com/turbot/steampipe-plugin-aws/pull/1554))
