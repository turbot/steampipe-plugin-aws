...
- Recompiled plugin with [steampipe-plugin-sdk v4.1.8](https://github.com/turbot/steampipe-plugin-aws/pull/1384) which fixes the default file limit issue. ([#1382](https://github.com/turbot/steampipe-plugin-aws/pull/1382))
