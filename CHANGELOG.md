...
- Fixed the `aws_vpc_security_group_rule` table to correctly handle the cross-referenced security group rules ([#875](https://github.com/turbot/steampipe-plugin-aws/pull/875))
