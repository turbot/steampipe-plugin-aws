...
- Updated: Default region for `us-gov` and `cn` partition will be `us-gov-west-1` and `cn-northwest-1` ([#613](https://github.com/turbot/steampipe-plugin-aws/pull/613))
...
- Fixed: AWS plugin tables will work properly with `AWS_REGION` or `AWS_DEFAULT_REGION` env variables ([#598](https://github.com/turbot/steampipe-plugin-aws/pull/598))
