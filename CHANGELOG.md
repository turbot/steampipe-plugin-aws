...
- Added `max_error_retry_attempts` and `min_error_retry_delay` optional config arguments to customize the error retry mechanism ([#914](https://github.com/turbot/steampipe-plugin-aws/pull/914))
