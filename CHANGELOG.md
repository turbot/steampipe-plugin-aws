...
- Optimized `aws_ssm_inventory` table's query performance by adding new optional key qual columns. ([#1980](https://github.com/turbot/steampipe-plugin-aws/pull/1980))
