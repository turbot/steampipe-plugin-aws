...
func passwordEnabledToBool(_ context.Context, d *transform.TransformData) (interface{}, error) {
	...
	// The value for the AWS root account <root_account> is always returned as not_supported for password_enabled by AWS API. The root password can not be disabled. Hence it has always a value associated.
