...
func Plugin(ctx context.Context) *plugin.Plugin {
	p := &plugin.Plugin{
		...
		TableMap: map[string]*plugin.Table{
			...
			"aws_opensearch_cluster_metric":                                tableAwsOpenSearchClusterMetric(ctx),
			"aws_opensearch_cluster_metric_daily":                          tableAwsOpenSearchClusterMetricDaily(ctx),
			"aws_opensearch_cluster_metric_hourly":                         tableAwsOpenSearchClusterMetricHourly(ctx),
