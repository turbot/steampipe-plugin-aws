...
func Plugin(ctx context.Context) *plugin.Plugin {
	p := &plugin.Plugin{
		...
		RateLimiters: []*rate_limiter.Definition{
			...
			{
				Name:           "aws_kinesis_list_streams_list_stream_consumers_list_tags_for_stream",
				MaxConcurrency: 5,
				FillRate:       5,
				BucketSize:     5,
			...
			// https://docs.aws.amazon.com/streams/latest/dev/service-sizes-and-limits.html#kds-api-limits
			{
				Name:           "aws_kinesis_describe_stream_summary",
				MaxConcurrency: 20,
				FillRate:       20,
				BucketSize:     20,
				Scope:          []string{"connection", "service", "action"},
		...
		TableMap: map[string]*plugin.Table{
			...
			"aws_directconnect_connection":                                 tableAwsDirectConnectConnection(ctx),
			...
			"aws_rds_global_cluster":                                       tableAwsRDSGlobalCluster(ctx),
			...
			"aws_ssm_service_setting":                                      tableAwsSSMServiceSetting(ctx),
			...
			"aws_ssoadmin_customer_policy_attachment":                      tableAwsSsoAdminCustomerPolicyAttachment(ctx),
