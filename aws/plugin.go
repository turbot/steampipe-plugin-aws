...
func Plugin(ctx context.Context) *plugin.Plugin {
	p := &plugin.Plugin{
		...
		RateLimiters: []*rate_limiter.Definition{
			...
			// AWS IAM Policy / Policy Attachment / Role - Limits to reduce throttling errors
			{
			...
			},
			{
				...
				FillRate:   35,
				Scope:      []string{"connection", "service", "action"},
				Where:      "service = 'iam' and action = 'GetPolicyVersion'",
			},
			{
				Name:       "aws_iam_policy_list_entities_for_policy",
				BucketSize: 40,
				FillRate:   40,
				Scope:      []string{"connection", "service", "action"},
				Where:      "service = 'iam' and action = 'ListEntitiesForPolicy'",
			},
			{
				Name:       "aws_iam_role_get_role",
				BucketSize: 15,
				FillRate:   15,
				Scope:      []string{"connection", "service", "action"},
				Where:      "service = 'iam' and action = 'GetRole'",
			},
			{
				Name:       "aws_iam_role_list_instance_profiles_for_role",
				BucketSize: 15,
				FillRate:   15,
				Scope:      []string{"connection", "service", "action"},
				Where:      "service = 'iam' and action = 'ListInstanceProfilesForRole'",
			},
			{
				Name:       "aws_iam_role_list_attached_role_policies",
				BucketSize: 15,
				FillRate:   15,
				Scope:      []string{"connection", "service", "action"},
				Where:      "service = 'iam' and action = 'ListAttachedRolePolicies'",
			},
			{
				Name:       "aws_iam_role_list_role_policies",
				BucketSize: 15,
				FillRate:   15,
				Scope:      []string{"connection", "service", "action"},
			...
			},
			{
				...
				BucketSize: 5,
				Scope:      []string{"connection", "region", "service", "action"},
				Where:      "service = 'ec2' and action = 'DescribeSnapshots'",
			},
			{
				...
				BucketSize: 5,
				Scope:      []string{"connection", "region", "service", "action"},
				Where:      "service = 'ec2' and action = 'DescribeImages'",
			},
			{
				...
				BucketSize: 10,
				Scope:      []string{"connection", "region", "service", "action"},
				Where:      "service = 'ec2' and action = 'DescribeInstances'",
			},
			{
				Name:       "aws_s3_get_bucket_acl",
				FillRate:   100,
				BucketSize: 100,
				Scope:      []string{"connection", "region", "service", "action"},
				Where:      "service = 's3' and action = 'GetBucketAcl'",
			},
			{
				Name:       "aws_s3_get_bucket_policy",
				FillRate:   100,
				BucketSize: 100,
				Scope:      []string{"connection", "region", "service", "action"},
				Where:      "service = 's3' and action = 'GetBucketPolicy'",
			},
			{
				...
				BucketSize: 100,
				Scope:      []string{"connection", "region", "service", "action"},
				Where:      "service = 's3' and action = 'ListObjectsV2'",
			},
			{
				Name:       "aws_logs_describe_log_streams",
				FillRate:   5,
				BucketSize: 5,
				Scope:      []string{"connection", "region", "service", "action"},
				Where:      "service = 'logs' and action = 'DescribeLogStreams'",
			},
			{
				...
				BucketSize: 5,
				Scope:      []string{"connection", "region", "service", "action"},
				Where:      "service = 'logs' and action = 'GetLogEvents'",
			},
			{
				...
				BucketSize: 2,
				Scope:      []string{"connection", "region", "service", "action"},
				Where:      "service = 'cloudtrail' and action = 'LookupEvents'",
			},
			{
				...
				BucketSize: 10,
				Scope:      []string{"connection", "region", "service", "action"},
				Where:      "service = 'cloudtrail' and action = 'DescribeTrails'",
			},
			{
				...
				BucketSize: 5,
				Scope:      []string{"connection", "region", "service", "action"},
				Where:      "service = 'config' and action = 'DescribeConfigRules'",
			},
			{
				Name:       "aws_config_get_compliance_details_by_config_rule",
				FillRate:   3,
				BucketSize: 3,
				Scope:      []string{"connection", "region", "service", "action"},
				Where:      "service = 'config' and action = 'GetComplianceDetailsByConfigRule'",
			},
			{
				...
				BucketSize: 5,
				Scope:      []string{"connection", "region", "service", "action"},
				Where:      "service = 'rds' and action = 'DescribeDBInstances'",
			},
			{
				Name:       "aws_rds_describe_db_snapshots",
				FillRate:   5,
				BucketSize: 5,
				Scope:      []string{"connection", "region", "service", "action"},
				Where:      "service = 'rds' and action = 'DescribeDBSnapshots'",
			},
			{
			...
			},
			{
				...
				BucketSize: 50,
				Scope:      []string{"connection", "region", "service", "action"},
				Where:      "service = 'lambda' and action = 'GetFunctionConfiguration'",
			},
		},
		TableMap: map[string]*plugin.Table{
			...
			"aws_api_gateway_account":                                      tableAwsAPIGatewayAccount(ctx),
			...
			"aws_connect_instance_attribute":                               tableAwsConnectInstanceAttribute(ctx),
			"aws_connect_instance":                                         tableAwsConnectInstance(ctx),
			...
			"aws_cost_by_resource_daily":                                   tableAwsCostByResourceDaily(ctx),
			"aws_cost_by_resource_hourly":                                  tableAwsCostByResourceHourly(ctx),
			"aws_cost_by_resource_monthly":                                 tableAwsCostByResourceMonthly(ctx),
			...
			"aws_iam_instance_profile":                                     tableAwsIamInstanceProfile(ctx),
			...
			"aws_savingsplans_savings_plan":                                tableAwsSavingsPlan(ctx),
			...
			"aws_vpc_security_group_vpc_association":                       tableAwsVpcSecurityGroupVpcAssociation(ctx),
