...
func Plugin(ctx context.Context) *plugin.Plugin {
	p := &plugin.Plugin{
		...
		TableMap: map[string]*plugin.Table{
			...
			"aws_dx_connection":                                            tableAwsDxConnection(ctx),
			"aws_dx_customer_metadata":                                     tableAwsDxCustomerMetadata(ctx),
			"aws_dx_gateway":                                               tableAwsDxGateway(ctx),
			"aws_dx_gateway_association":                                   tableAwsDxGatewayAssociation(ctx),
			"aws_dx_gateway_association_proposal":                          tableAwsDxGatewayAssociationProposal(ctx),
			"aws_dx_gateway_attachment":                                    tableAwsDxGatewayAttachment(ctx),
			"aws_dx_hosted_connection":                                     tableAwsDxHostedConnection(ctx),
			"aws_dx_interconnect":                                          tableAwsDxInterconnect(ctx),
			"aws_dx_lag":                                                   tableAwsDxLag(ctx),
			"aws_dx_virtual_interface":                                     tableAwsDxVirtualInterface(ctx),
